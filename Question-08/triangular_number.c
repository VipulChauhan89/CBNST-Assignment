/*
    A triangular number is one which can be represented by that number of pebbles in a symmetric triangle. 
...
int main()
{
    ...
    if(triangular(n))
    {
        printf("Number is Triangular number.\n");
    }
    else
    {
        printf("Number is not Triangular number.\n");
    }
    printf("\n");
    return 0;
}